...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://api2.frontapp.com";
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("http", new HttpBearerAuth("bearer"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api2.frontapp.com)
